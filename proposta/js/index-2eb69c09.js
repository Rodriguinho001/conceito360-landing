...
// ============================================================
// FIX: AudioContext autoplay policy — Chrome blocks AudioContext
// without user gesture. We patch resume() to always resolve
// so App3D init doesn't hang waiting for audio permission.
// Audio will start properly on first user interaction.
// ============================================================
(function(){
  ...
  AC.prototype.resume = function(){
    // Call real resume (may stay suspended), but always resolve immediately
    try{ origResume.call(this); }catch(e){}
    return Promise.resolve();
  };
  console.log('[PATCH] AudioContext.resume() patched for autoplay policy bypass');
})();
