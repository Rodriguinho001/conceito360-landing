...
(async () => {
    ...
    await page.evaluate(() => {
        ...
        // Add a light so we can see the MeshStandardMaterial
        const light = new window.THREE.DirectionalLight(0xffffff, 1);
        light.position.set(10, 10, 10);
        window.app3D.scene.add(light);
        const ambient = new window.THREE.AmbientLight(0x404040);
        window.app3D.scene.add(ambient);
    });
